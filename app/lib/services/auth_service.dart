...
class AuthService extends ChangeNotifier {
    ...
    Future<AuthInitResponse> initiateAuth() async {
        final request = AuthInitRequest(
            deviceId: '', // Will be generated by server
        ...
        if (response.statusCode == 200) {
            ...
            _tempDeviceId = authResponse.deviceId; // Use device ID from server
            return authResponse;
        }
            ...
            try {
                ...
                if (response.statusCode == 200) {
                    ...
                    if (data['session_id'] != null) {
                        ...
                        // Use the temp device ID as the permanent device ID
    ...
    /// Periodically check for server mode changes and validate session
    Future<bool> checkAuthStatusWithModeValidation() async {
        ...
        try {
            ...
            if (modeResponse.statusCode == 200) {
                ...
                // Validate session with mode checking
                await _validateSessionMode(isDemo);
            }

            // Then do regular session validation
            final isValid = await _validateSession();
