...
class AIModelManager:
    ...
    def __init__(self):
        ...
        self._default_model: str = "ollama"
    ...
    def _setup_default_models(self):
        ...
        # OpenAI configuration (if API key provided)
        ...
        # Anthropic configuration (if API key provided)
        ...
        # Set default model
        if hasattr(settings, 'DEFAULT_AI_MODEL') and settings.DEFAULT_AI_MODEL in self._models:
            self._default_model = settings.DEFAULT_AI_MODEL
    ...
    def get_model(self, model_id: Optional[str] = None) -> AIModelConfig:
